...
//打开摄像头
AVFormatContext *&AvUtils::openCamera(const std::string& url) {
//    static AVFormatContext *pFormatCtx = nullptr;//如果不初始化为nullptr，程序会异常。
    AVInputFormat *iformat = av_find_input_format("dshow");
    if (avformat_open_input(&fmt_ctx, url.c_str(), iformat, nullptr) != 0)
    {
...
int AvUtils::decode_packet(int *got_frame, int cached)
{
    int ret = 0;
...
int AvUtils::open_codec_context(int *stream_idx,
